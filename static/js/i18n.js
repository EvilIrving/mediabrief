...
window.VTI18nMethods = {
  ...
  _switchLang(lang) {
    ...
    if (this.rssImportJsonBtn && !this.rssImportJsonBtn.disabled) {
      this.rssImportJsonBtn.innerHTML = `<i class="fas fa-file-import"></i> <span>${this.t('import_json_feeds')}</span>`;
    }
  },
};
