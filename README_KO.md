...
- 브라우저 기록: History 탭에서 과거 요약 검색·확장·삭제. IndexedDB 저장, 데이터베이스 서버 불필요
- 모바일 지원: 반응형 레이아웃
...
8. **기록 탐색**: **History** 탭을 열어 IndexedDB에 저장된 과거 요약 검색 및 관리
9. **RSS 자동화**: **RSS** 탭을 열고 피드 구독, 항목 새로고침, 원클릭 요약 또는 다운로드
