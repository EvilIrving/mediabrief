...
class MediaRecoveryActions:
    ...
    def action_specs(self) -> Sequence[dict[str, Any]]:
        return (
            {"name": "inspect_failure", "arguments": {}},
            {"name": "inspect_runtime", "arguments": {}},
            {"name": "run_ytdlp", "arguments": {"profile": sorted(self._allowed_ytdlp_profiles())}},
            {"name": "prepare_ytdlp_update", "arguments": {}},
            {"name": "http_request", "arguments": {"method": ["GET", "HEAD"], "path": "allowed URL/path", "proposal_id": "proposal_N"}},
            {"name": "run_candidate_parser", "arguments": {"response_id": "response_N", "source": "single-use JavaScript <= 20KB"}},
            {"name": "use_browser_session", "arguments": {}},
            {"name": "request_youtube_challenge_capability", "arguments": {}},
            {"name": "download_candidate", "arguments": {"candidate_id": "candidate_N"}},
            {"name": "validate_media", "arguments": {}},
            {"name": "validate_subtitle", "arguments": {}},
            {"name": "set_user_message", "arguments": {"message": "plain text <= 300 chars"}},
